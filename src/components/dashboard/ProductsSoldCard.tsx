  ...
  return (
    <>
      ...
      <div style={{
        ...
        <div className="h-[124px] overflow-y-auto custom-scrollbar overscroll-contain transform-gpu" style={{ display: 'flex', flexDirection: 'column', gap: '14px', paddingRight: '4px' }}>
          {topProducts.slice(0, 56).map((p, i) => {
            return (
              <div
                key={p.description}
                style={{
